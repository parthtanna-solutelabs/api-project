class DosesController < ApplicationController
    ...
    def create
      ...
      if @dose.save
        ...
        render json: {error:" Dose not created"}, status: :unprocessable_entity
      end
    end
    ...
    def update
      ...
      if @dose.update(dose_params)
        ...
        render json: {error:" Dose not updated"}, status: :unprocessable_entity
      end
    end
    ...
    def destroy
      ...
      if @dose.destroy
        ...
        render json: {error:" Dose not deleted"}, status: :unprocessable_entity
      end
    end
