class PacksController < ApplicationController
    ...
    def create
      ...
      if @pack.save
        ...
        render json: {error:"Pack not created"}, status: :unprocessable_entity
      end
    end
    def edit
      @pack = Pack.find(params[:id])
    ...
    def update
      ...
      if @pack.update(pack_params)
        ...
        render json: {error:"Pack not updated"}, status: :unprocessable_entity
      end
    end
    ...
    def destroy
      ...
      if @pack.destroy
        ...
        render json: {error:"Pack not deleted"}, status: :unprocessable_entity
      end
    end
